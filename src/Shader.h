...
public:
	...
	void SetUniformMat4f(const std::string& name, const mat4& matrix, bool transpose = false);
	void SetUniformMat4fArray(const std::string& name, const mat4* matArray, size_t size);
